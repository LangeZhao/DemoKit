...
-(void)application:(UIApplication *)application performActionForShortcutItem:(UIApplicationShortcutItem *)shortcutItem completionHandler:(void (^)(BOOL))completionHandler
{
    ...
    [[BeeHive shareInstance].context.touchShortcutItem setCompletionHandler:completionHandler];
...
- (void)application:(UIApplication *)application didRegisterUserNotificationSettings:(UIUserNotificationSettings *)notificationSettings {
    [[BeeHive shareInstance].context.notificationsItem setNotificationSettings:notificationSettings];
    [[BHModuleManager sharedManager] triggerEvent:BHMDidRegisterUserNotificationSettings];
}
...
- (void)application:(UIApplication *)application handleWatchKitExtensionRequest:(NSDictionary *)userInfo reply:(void(^)(NSDictionary *replyInfo))reply{
    [[BeeHive shareInstance].context.watchKitExtensionItem setUserInfo:userInfo];
    [[BeeHive shareInstance].context.watchKitExtensionItem setReply:reply];
    [[BHModuleManager sharedManager] triggerEvent:BHMHandleWatchKitExtensionRequest];
}
...
@implementation BHWatchKitExtensionItem
