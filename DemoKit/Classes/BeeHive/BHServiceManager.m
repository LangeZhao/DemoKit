...
- (id)createService:(Protocol *)service
{
    ...
    BOOL bImplShareInstance = [implClass respondsToSelector:@selector(shareInstance)];
    ...
    //使之支持 外部自己实现 shareInstance
    else if (bImplShareInstance) {
        implInstance = [implClass shareInstance];
    }
    else{
