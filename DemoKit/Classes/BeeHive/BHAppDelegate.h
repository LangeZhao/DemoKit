...
@property(nonatomic, copy) shortcutItemCompletionHandler completionHandler;
#endif
...
typedef void(^BHWatchKitExtensionReply)(NSDictionary *replyInfo);

@interface BHWatchKitExtensionItem : NSObject

@property (nonatomic, strong) NSDictionary *userInfo;
@property (nonatomic, copy) BHWatchKitExtensionReply reply;
