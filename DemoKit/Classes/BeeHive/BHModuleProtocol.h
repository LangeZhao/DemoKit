...
- (void)modInitAfterCreatedMainScreenEvent:(BHContext *)context;

//IndexViewController ViewDidAppear后调用该方法，注意该方法内部实现是异步调用，用于项目处理开机加载，一般开机加载的处理放到该方法里，不要用以上方法，并且内部尽量用 异步线程处理
- (void)modIndexPageLaunchedEvent:(BHContext *)context;
...
- (void)modDidRegisterUserNotificationSettings:(BHContext *)context;
